<?php
/**
 * Global Header Navigation & Meta Includes
 */
if (!defined('BASE_URL')) {
...
<head>
    ...
    <title><?php echo htmlspecialchars($pageTitle); ?> - ResiPro</title>
    ...
    <!-- Bootstrap 5.3 CSS -->
    <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.3/dist/css/bootstrap.min.php" rel="stylesheet" integrity="sha384-QWTKZyjpPEjISv5WaRU9OFeRpok6YctnYmDr5pNlyT2bRjXh0JMhjY6hW+ALEwIH" crossorigin="anonymous">
    <!-- Fallback standard Bootstrap CSS CDN -->
