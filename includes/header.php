...
<head>
    ...
    <!-- Bootstrap Bundle JS in Head so it is available globally on all views -->
                ...
                <div class="dropdown">
                    <button class="btn btn-link text-decoration-none p-0 d-flex align-items-center gap-2" type="button" data-bs-toggle="dropdown" aria-expanded="false">
                        <?php if (!empty($currentUser['avatar'])): ?>
                            <img src="<?php echo BASE_URL . htmlspecialchars($currentUser['avatar']); ?>" alt="Profile" class="rounded-circle border" style="width:40px;height:40px;min-width:40px;min-height:40px;aspect-ratio:1/1;object-fit:cover;flex-shrink:0;">
                        <?php else: ?>
                            <div class="user-avatar-badge" style="width:40px;height:40px;min-width:40px;min-height:40px;aspect-ratio:1/1;flex-shrink:0;">
