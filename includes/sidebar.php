...
<aside id="sidebar">
    ...
    <div class="sidebar-footer">
        <a href="<?php echo BASE_URL; ?>views/shared/profile.php" class="text-decoration-none d-flex align-items-center gap-2" title="Manage Profile & Settings">
            <?php if (!empty($currentUser['avatar'])): ?>
                <img src="<?php echo BASE_URL . htmlspecialchars($currentUser['avatar']); ?>" alt="Profile" class="rounded-circle border" style="width:34px;height:34px;min-width:34px;min-height:34px;aspect-ratio:1/1;object-fit:cover;flex-shrink:0;">
            <?php else: ?>
                <div class="user-avatar-badge" style="width: 34px; height: 34px; min-width:34px; min-height:34px; aspect-ratio:1/1; font-size: 0.85rem; flex-shrink:0;">
